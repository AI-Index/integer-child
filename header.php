...
<div id="page" class="hfeed site">
    ...
    <header class="site-header initial-reveal" role="banner">
    <!-- <header id="masthead" class="site-header initial-reveal" role="banner"> -->
        ...
        <a href= "http://blog.aiindex.org" class="header-logo-link">
            <img class="header-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/index_logo_square_blue.png"/>
        </a>
